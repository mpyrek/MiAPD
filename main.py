...
def menu_callback(window):
    ...
    # get expert button
    expert_button = ttk.Button(window, text="Get the Experts' view", command = lambda : get_expert(window, list(window.scale_dicts.keys()).index(window.menu_holder.get()) + 4, rs1.getValues()))
